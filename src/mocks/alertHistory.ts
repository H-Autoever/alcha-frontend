...
export const items: Notification[] = [
    ...
    { id: '3', createdAt: new Date(Date.now() - 7200_000).toISOString(), title: '배터리 전압 낮음', message: '12.1V로 낮아졌습니다.', level: 'warning' },
    { id: '4', createdAt: new Date(Date.now() - 1800_000).toISOString(), title: '문 미닫힘', message: '좌측 뒷문이 완전히 닫히지 않았습니다.', level: 'info' }
]